...
public class Grafik1jam extends AppCompatActivity implements View.OnClickListener, OnChartGestureListener, OnChartValueSelectedListener {
    private LinearLayout intentKelembaban1jam;

    protected Cursor cursor;
    DataHelper dbHelper;
    private static final String TAG = "Grafik1jam";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_grafik1jam);

        dbHelper = new DataHelper(this);

        timegraph = (TextView) findViewById(R.id.timegrap1jamsuhu);

        intentKelembaban1jam = (LinearLayout)findViewById(R.id.glembabpindah1jam);
        intentKelembaban1jam.setOnClickListener(this);

        ImageButton Grafik1jam = (ImageButton) findViewById(R.id.backGrafik1jam);
        Grafik1jam.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void parseJSON(){
        ...
        mChart = (LineChart) findViewById(R.id.lineChartsuh1jam);

        mChart.setOnChartGestureListener(Grafik1jam.this);
        ...
        LimitLine upper_limit = new LimitLine(31,"Danger");
        ...
        LimitLine lower_limit = new LimitLine(17,"too Low");
        ...
        for (int i = rNewTampDataList.size()-1; i >0 ; i--) {
            yValues.add(new Entry(j,Float.parseFloat(rNewTampDataList.get(i).getSuhu())));
            j+=1;
        }
        ...
        LineDataSet set1 = new LineDataSet(yValues,"Suhu");
    ...
    public void onClick(View view) {
        Intent i;
        switch (view.getId()){
            case R.id.glembabpindah1jam : i = new Intent ( this, GrafikKel1Jam.class ); startActivity ( i ); break;
            default:break;
        }
    }
    ...
    public void onValueSelected(Entry e, Highlight h) {
        ...
        Toast.makeText(Grafik1jam.this,msg,Toast.LENGTH_LONG).show();
    }
    ...
    public void ref(final LineData data){
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Snackbar snackbar = Snackbar.make(mChart, "Grafik Perjam Suhu Berhasil Disegarkan.", Snackbar.LENGTH_LONG);
                snackbar.show();
